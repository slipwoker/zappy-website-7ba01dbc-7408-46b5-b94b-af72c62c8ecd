            ...
            if (isValid) {
                ...
                .then(function(response) {
                    if (response.ok) {
                        ...
                        successMessage.style.cssText = 'color: #27ae60; padding: 1rem; margin-top: 1rem; background: #f0faf4; border-radius: 4px;';
                ...
                .catch(function(error) {
                    ...
                    errorMessage.style.cssText = 'color: #e74c3c; padding: 1rem; margin-top: 1rem; background: #fdf0ef; border-radius: 4px;';
                ...
                .finally(function() {
                    if (submitButton) {
                        ...
                        submitButton.textContent = submitButton.getAttribute('data-original-text') || 'Send';
                    }
                });
            }
        });
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '7ba01dbc-7408-46b5-b94b-af72c62c8ecd',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '7ba01dbc-7408-46b5-b94b-af72c62c8ecd';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '7ba01dbc-7408-46b5-b94b-af72c62c8ecd';
